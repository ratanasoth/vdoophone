        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/company/update')}}" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return confirm('You want to save changes?')">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$company->code}}" name="code" id="code">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$company->name}}" id="name" name="name" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="control-label col-sm-3 lb">Email</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$company->email}}" id="email" name="email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$company->address}}" id="address" name="address">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tax_code" class="control-label col-sm-3 lb">Tax Code</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$company->tax_no}}" id="tax_code" name="tax_code">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="description" class="control-label col-sm-3 lb">Description</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$company->description}}" id="description" name="description">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <br>
                                            <img src="{{asset("uploads/companies/".$company->logo)}}" alt="Logo" width="120" id="preview">
                                            <p>
                                                <br>
