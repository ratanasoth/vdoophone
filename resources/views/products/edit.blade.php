        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/product/update')}}" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return confirm('You want to save?')">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="" class="control-label col-sm-3 lb"></label>
                                    <div class="col-sm-8">
                            ...
                            <input type="file" class="form-control" id="pimg" name="pimg" onchange="loadFile(event)">
                                <br>
                                <img src="{{asset("uploads/products/".$product->photo)}}" alt="photo" width="120" id="preview">
