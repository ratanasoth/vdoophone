        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/attribute/save')}}" class="form-horizontal" method="post" onsubmit="return confirm('You want to save?')">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{old('value')}}" id="value" name="value" required>
                                        <p>
                                            <br>
